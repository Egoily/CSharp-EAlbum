...
namespace EgoDevil.Utilities.UI
{
    ...
    public partial class TrackBarEx : Control
    {
        ...
        public TrackBarEx(int min, int max, int value)
        {
            InitializeComponent();
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (Capture & e.Button == MouseButtons.Left)
            {
                ...
                p -= margin;
                float coef = (float)(barMaximum - barMinimum) / (float)((barOrientation == Orientation.Horizontal ? ClientSize.Width : ClientSize.Height) - 2 * margin);
