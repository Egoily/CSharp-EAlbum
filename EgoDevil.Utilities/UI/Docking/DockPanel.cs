...
// attribute instead of the control name. #3 use the "<default namespace>.<resourcename>" string to
// locate the resource.
...
namespace EgoDevil.Utilities.UI.Docking
{
    ...
    public partial class DockPanel : Panel
    {
        ...
        /// <summary>
        /// Determines the color with which the client rectangle will be drawn. If you take this
        /// property instead of the BackColor it will not have any influence on the borders to the
        /// surrounding controls (DockPane). If you use BackColor the borders to the surrounding
        /// controls (DockPane) will also change there colors. Alternatively you can use both of
        /// them (BackColor to draw the define the color of the borders and DockBackColor to define
        /// the color of the client rectangle). For Backgroundimages: Set your prefered Image, then
        /// set the DockBackColor and the BackColor to the same Color (Control)
        /// </summary>
