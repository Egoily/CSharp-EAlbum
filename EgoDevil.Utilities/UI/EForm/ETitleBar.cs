...
namespace EgoDevil.Utilities.UI.EForm
{
    public class ETitleBar
    {
        ...
        public enum ETitleBarBackImageAlign
        {
            /// <summary>
            /// Left aligned image.
            /// </summary>
        ...
        private Color m_clrFillStart = Color.FromArgb(227, 235, 247);
        private Color m_clrFillEnd = Color.FromArgb(205, 224, 251);

        private Color m_clrUpperFillStart = Color.FromArgb(227, 235, 247);
        private Color m_clrUpperFillEnd = Color.FromArgb(205, 224, 251);

        private string m_sCaption = "EForm";
        private Font m_fntCaption = new Font("Visitor TT2 BRK", 9);
        private Color m_clrCaptionFont = Color.FromArgb(62, 106, 170);

        private Color m_clrButtonBoxStart = Color.FromArgb(134, 125, 126);
        private Color m_clrButtonBoxEnd = Color.FromArgb(134, 125, 126);
        private Color m_clrButtonBoxInner = Color.FromArgb(154, 174, 213);
        private Color m_clrButtonBoxOuter = Color.FromArgb(246, 244, 252);
        private List<Color> m_ButtonBoxColors = new List<Color>();

        private Color m_clrOuterTitleBarColor = Color.FromArgb(154, 174, 213);
        private Color m_clrInnerTitleBarColor = Color.FromArgb(246, 244, 252);
        ...
        public EButtonBoxFill m_eButtonBoxFill = EButtonBoxFill.ColorMix;

        private List<EFormCtrlButtons> m_eCtrlButtons = new List<EFormCtrlButtons>();
        ...
        public bool MinimizeBox
        {
            ...
            set
            {
                ...
                foreach (EFormCtrlButtons ebtn in CtrlButtons)
                {
                    if (ebtn.ButtonType == EFormCtrlButtons.ECtrlType.Minimize)
                    {
                        ebtn.Visible = value;
                        break;
                    }
        ...
        public EButtonBoxFill ButtonBoxFill
        {
            get
            {
        ...
        public List<EFormCtrlButtons> CtrlButtons
        {
            get
            {
        ...
        /// Symbol of a button.
        /// </summary>
        private EFormCtrlButtons.EButtonStyle m_eButtonStyle = EFormCtrlButtons.EButtonStyle.Pixeled;
        ...
        public ETitleBar()
        {
            ...
            m_ButtonBoxColors.Add(Color.FromArgb(205, 224, 248));
            m_ButtonBoxColors.Add(Color.FromArgb(217, 232, 250));
            m_ButtonBoxColors.Add(Color.FromArgb(223, 236, 252));

            // initialize titlebar mix colors:
            m_TitleBarMix.Add(Color.FromArgb(227, 235, 247));
            m_TitleBarMix.Add(Color.FromArgb(221, 234, 251));
        ...
        /// <param name="rc"></param>
        private void DrawTitleBarText(Graphics g, Color clrCaption, string sCaption, Rectangle rc)
        {
            ...
            g.DrawString(sCaption, m_fntCaption, sb, rc, sf);
        ...
        private void DrawOuterTitleBarBorder(Graphics g, Rectangle rcTitleBar, Color clrOuterBorder)
        {
            using (GraphicsPath XTitleBarPath = BuildTitleBarShape(rcTitleBar))
            {
                ...
                {
                    g.DrawPath(pOuter, XTitleBarPath);
                }
            }
        }
        /// <summary>
        ...
        private GraphicsPath BuildTitleBarShape(Rectangle rc)
        {
            ...
            {
                case ETitleBarType.Rounded:
                    e.AddArc(rc.Left, rc.Top, rc.Height, rc.Height, 90, 180);
                    e.AddLine(rc.Left + rc.Height / 2, rc.Top, rc.Right, rc.Top);
        ...
        private void DrawTitleBarBackImage(Graphics g, Rectangle rcTitlebar, GraphicsPath clip)
        {
            if (m_TitleBarBackImage != null)
            {
                ...
                Rectangle rcIcon = new Rectangle(0, 0, lW, lH);
                switch (m_eTitleBarImageAlign)
                {
                    case ETitleBarBackImageAlign.Right:
        ...
        private void DrawInnerCtrlBoxBorder(Graphics g, Rectangle rcBox, Color clrInnerBorder)
        {
            ...
            using (GraphicsPath XTitleBarBox = BuildCtrlButtonsBox(rcBox))
            {
                using (Pen pInner = new Pen(clrInnerBorder))
                {
                    g.DrawPath(pInner, XTitleBarBox);
                }
            }
        }
        public GraphicsPath BuildCtrlButtonsBox(Rectangle r)
        {
            ...
            {
                case ETitleBarType.Rounded:
                    XButtonBox.AddBezier(new Point(r.Left - 5, r.Top + 1), new Point(r.Left + 20, r.Top + 5), new Point(r.Left - 5, r.Bottom + 2), new Point(r.Left + 45, r.Bottom));
                    XButtonBox.AddLine(r.Left + 45, r.Bottom, r.Right - 5, r.Bottom);
