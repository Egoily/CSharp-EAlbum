...
namespace EgoDevil.Utilities.UI.EPanels
{
	...
	/// </summary>
    /// <remarks>The EPanel is a control that contains other controls.
    /// You can use a EPanel to group collections of controls such as the XPanderPanelList control.
    /// On top of the EPanel there is the captionbar. This captionbar may contain an image and text.
