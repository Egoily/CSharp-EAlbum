...
namespace EgoDevil.Utilities.UI.EPanels
{
    ...
    /// </summary>
    /// <remarks>
    /// The EPanel is a control that contains other controls. You can use a EPanel to group
    /// collections of controls such as the XPanderPanelList control. On top of the EPanel there is
    /// the captionbar. This captionbar may contain an image and text. According to it's dockstyle
    /// and properties the panel is collapsable and/or closable.
    /// </remarks>
    ...
    public partial class EPanel : BaseEPanel
    {
        ...
        /// <summary>
        /// Gets or sets the associated Splitter. If there is a splitter associated to a panel, the
        /// splitter visibility always changes when the visibilty of this panel changes.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the controls caption professional colorscheme is
        /// the same then the XPanderPanels
        /// </summary>
        ...
        /// <summary>
        /// Gets the rectangle that represents the display area of the EPanel.
        /// </summary>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    ...
    internal class PanelDesigner : System.Windows.Forms.Design.ParentControlDesigner
    {
        ...
        /// <summary>
        /// Called when the control that the designer is managing has painted its surface so the
        /// designer can paint any additional adornments on top of the control.
        /// </summary>
    ...
    /// <summary>
    /// Provides the class for types that define a list of items used to create a smart tag panel
    /// for the Panel.
    /// </summary>
    public class PanelDesignerActionList : DesignerActionList
    {
        ...
        public bool ShowCaptionbar
        {
            get { return this.EPanel.ShowCaptionbar; }
        ...
        public bool ShowTransparentBackground
        {
            get { return this.EPanel.ShowTransparentBackground; }
        ...
        public bool ShowXPanderPanelProfessionalStyle
        {
            get { return this.EPanel.ShowXPanderPanelProfessionalStyle; }
        ...
        {
            get { return this.EPanel.ShowExpandIcon; }
        ...
        {
            get { return this.EPanel.ShowCloseIcon; }
        ...
        {
            get { return this.EPanel.PanelStyle; }
        ...
        {
            get { return this.EPanel.ColorScheme; }
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            actionItems.Add(
                ...
                GetCategory(this.EPanel, "ShowTransparentBackground")));

            actionItems.Add(
                new DesignerActionPropertyItem(
                "ShowXPanderPanelProfessionalStyle",
                "Show the XPanderPanels professional colorscheme",
                GetCategory(this.EPanel, "ShowXPanderPanelProfessionalStyle")));

            actionItems.Add(
                new DesignerActionPropertyItem(
                "ShowCaptionbar",
                "Show the captionbar on top of the panel",
                GetCategory(this.EPanel, "ShowCaptionbar")));

            actionItems.Add(
                new DesignerActionPropertyItem(
                "ShowExpandIcon",
                "Show the expand panel icon (not at DockStyle.None or DockStyle.Fill)",
                GetCategory(this.EPanel, "ShowExpandIcon")));

            actionItems.Add(
                new DesignerActionPropertyItem(
                "ShowCloseIcon",
                "Show the close panel icon (not at DockStyle.None or DockStyle.Fill)",
                GetCategory(this.EPanel, "ShowCloseIcon")));

            actionItems.Add(
                new DesignerActionPropertyItem(
                "PanelStyle",
                "Select PanelStyle",
                GetCategory(this.EPanel, "PanelStyle")));

            actionItems.Add(
               new DesignerActionPropertyItem(
               "ColorScheme",
               "Select ColorScheme",
               GetCategory(this.EPanel, "ColorScheme")));
        ...
        public void ToggleDockStyle()
        {
            ...
            if (this.EPanel.Dock != DockStyle.Fill)
            {
        ...
        {
            get { return (EPanel)this.Component; }
        }
