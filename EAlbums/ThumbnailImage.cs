...
namespace EAlbums
{
    public class ThumbnailImageCreator
    {
        ...
        public static Bitmap CreateThumbnailImage(string originalImagePath, string thumbnailPath, int width, int height)
        {
            string outthumbnailPath;
           return CreateThumbnailImage(originalImagePath, thumbnailPath, width, height, out outthumbnailPath);
        }
        ...
        public static Bitmap CreateThumbnailImage(string originalImagePath, string thumbnailPath, int width, int height, out string outthumbnailPath)
        {
