...
namespace ExtendedPictureBoxLib.Animators
{
    ...
    public partial class ExtendedPictureBoxZoomAnimator : Animations.AnimatorBase
    {
        ...
        public ExtendedPictureBoxZoomAnimator(IContainer container)
            : base(container)
        {
            Initialize();
        }
        ...
        /// Creates a new instance.
        /// </summary>
        public ExtendedPictureBoxZoomAnimator()
        {
            Initialize();
        }
        ...
        /// cref="ExtendedPictureBoxLib.ExtendedPictureBox.Zoom"/> should be animated.
        /// </summary>
