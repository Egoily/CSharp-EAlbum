...
namespace ExtendedPictureBoxLib.Animators
{
    ...
    public partial class ExtendedPictureBoxShadowOffsetAnimator : ExtendedPictureBoxOffsetAnimatorBase
    {
        ...
        public override ExtendedPictureBox ExtendedPictureBox
        {
            ...
            set
            {
                if (base.ExtendedPictureBox != null)
                    base.ExtendedPictureBox.ShadowOffsetChanged -= new EventHandler(OnCurrentValueChanged);
        ...
        {
            get { return base.ExtendedPictureBox.ShadowOffset; }
            set { base.ExtendedPictureBox.ShadowOffset = value; }
        }
