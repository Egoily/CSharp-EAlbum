...
{
    /// <summary>
    /// Control taking a <see cref="ProgressStepCollection"/>, creating one <see
    ...
    public partial class AnimatedPicturesProgressBar : System.Windows.Forms.UserControl, ISupportInitialize
    {
        ...
        private ProgressStepCollection _steps;
        ...
        /// <summary>
        /// Gets or sets whether the <see cref="ExtendedPictureBox.ExtraImage"/> s should be shown
        /// or not.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets whether the <see cref="ExtendedPictureBox.ExtraImageRotationAngle"/> should
        /// be animated or not.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets whether the <see cref="ExtendedPictureBox.BackColor"/>, <see
        /// cref="ExtendedPictureBox.BackColor2"/> and <see
        /// cref="ExtendedPictureBox.BackColorGradientRotationAngle"/> should be animated or not.
        /// </summary>
        ...
        /// <summary>
        /// Gets a collection where <see cref="ProgressStep"/> s can be added/edited or removed in
        /// order to configure the steps which should be shown by this instance. Note that changes
        /// to this collection do not have any effect until <see cref="EndInit"/> is called.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets whether a call to <see cref="NextStep"/> should be blocked until the
        /// animation has finished. This might be useful when the background processing is not
        /// located in a separate thread and would block the GUI thread.
        /// </summary>
        ...
        /// <summary>
        /// Gets the index of the current <see cref="ProgressStep"/> instance within the <see
        /// cref="Steps"/> collection.
        /// </summary>
        [Browsable(false)]
        ...
        /// <summary>
        /// Gets or sets the <see cref="Control"/> which should be notified when the step progress
        /// has changed by setting its <see cref="Control.Text"/> property. This can be used for
        /// example for setting notification texts in a separate <see cref="Label"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the text which should be broadcasted when all steps have been set to <see
        /// cref="FinishedState"/> and thus the processing should be over. To insert the total count
        /// of steps dynamically into this text just insert '{0}' a the position where the count
        /// should be displayed.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="ExtendedPictureBox.ExtraImage"/> which should be shown when
        /// a step is in initial state.
        /// </summary>
        [Browsable(true), Category("Appearance")]
        ...
        /// <summary>
        /// Gets or sets the <see cref="ExtendedPictureBox.ExtraImage"/> which should be shown while
        ...
        public void Reset()
        {
            foreach (AnimatedPictureBox animatedPictureBox in this.Controls)
            {
        ...
        {
            foreach (AnimatedPictureBox animatedPictureBox in this.Controls)
                ((StepAnimators)animatedPictureBox.Tag).Stop();
        }
        ...
        private AnimatedPictureBox GetAnimatedPictureBox(int index)
        {
            return this.Controls[index] as AnimatedPictureBox;
        }
        ...
        /// <summary>
        /// Raises the <see cref="Control.Resize"/> event and repositions the contained steps.
        /// </summary>
        ...
        /// <summary>
        /// Indicates the designer whether <see cref="InitialState"/> needs to be serialized.
        /// </summary>
        ...
        /// <summary>
        /// Indicates the designer whether <see cref="InProgressState"/> needs to be serialized.
        /// </summary>
        ...
        /// <summary>
        /// Indicates the designer whether <see cref="FinishedState"/> needs to be serialized.
        /// </summary>
        ...
        /// <summary>
        /// Indicates the designer whether <see cref="InitialExtraImage"/> needs to be serialized.
        /// </summary>
        ...
        /// <summary>
        /// Indicates the designer whether <see cref="InProgressExtraImage"/> needs to be serialized.
        /// </summary>
        ...
        /// <summary>
        /// Indicates the designer whether <see cref="FinishedExtraImage"/> needs to be serialized.
        /// </summary>
